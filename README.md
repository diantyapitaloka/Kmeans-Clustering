...
- Vulnerability to Noise: Random data points from one-time tourists or accidental clicks can act as background noise that shifts the cluster boundaries. Left unchecked and the algorithm will waste computational energy trying to accommodate these irrelevant points into your core shopper segment.
