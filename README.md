...
- Cluster Density Assumptions: The algorithm assumes all clusters have roughly the same density and spatial spread. It will struggle if your "Luxury Shoppers" are a small, also tightly packed group while your "General Foot-Traffic" is a massive, widely dispersed cloud.
