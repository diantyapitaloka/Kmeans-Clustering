...
- Memory and Scaling Limits: Because the algorithm requires calculating distances between every single customer and every centroid in each iteration, hence it can become incredibly slow with massive datasets. For millions of rows of transaction data, you often need to switch to Mini-Batch KMeans to keep processing times reasonable.
