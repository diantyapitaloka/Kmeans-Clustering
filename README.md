...
- Spherical Cluster Assumption: The algorithm relies on a distance metric that naturally builds circular or spherical groups around a central point. Hence, if your true customer segments naturally form elongated or curved shapes, KMeans will incorrectly split them into unnatural circular pieces.
