...
- Hard Clustering Limitations: K-Means performs "hard assignment," meaning every shopper is forced into exactly one group with 100% certainty. This fails to capture "hybrid" customers who might transition between segments, such as a budget shopper who splurges during holiday sales.
