...
- Sensitivity to Outliers: A single "Whale" (an extreme high-spender far beyond the norm) can pull a centroid away from the actual center of a cluster. These outliers can distort your segments. It is often better to detect and handle these anomalies before running the algorithms.
