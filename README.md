...
- Sensitivity to Outliers: A single "Whale" (an extreme high-spender far beyond the norm) can pull a centroid away from the actual centers of a cluster. These outliers can distort your segments. It is often better to detect and handle these anomalies before to running the algorithms.
