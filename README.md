...
- The algorithm starts by randomly placing initial centroids. If these starting points are poorly placed, the model can get stuck in a local optimum, leading to inconsistent results across different runs. Using K-Means++ initialization helps mitigate this by spreading out the initial centroids, but it’s a critical factor to keep in mind for reproducibility.
