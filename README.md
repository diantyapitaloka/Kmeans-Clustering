...
- Local Optima Risk: The algorithm's final result depends heavily on where the initial "seeds" or centroids are randomly placed. To avoid inconsistent results across different runs, always use the K-Means++ initialization to ensure a more stable and reproducible segmentation.
